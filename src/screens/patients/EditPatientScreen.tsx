...
type EditPatientScreenProps = {
  navigation: NativeStackNavigationProp<PatientStackParamList, 'EditPatient'>;
};

export default function EditPatientScreen({ navigation }: EditPatientScreenProps) {
  return (
