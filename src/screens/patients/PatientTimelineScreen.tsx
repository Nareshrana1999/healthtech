...
type PatientTimelineScreenProps = {
  navigation: NativeStackNavigationProp<PatientStackParamList, 'PatientTimeline'>;
};

export default function PatientTimelineScreen({ navigation }: PatientTimelineScreenProps) {
  return (
