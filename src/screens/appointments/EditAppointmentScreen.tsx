...
type EditAppointmentScreenProps = {
  navigation: NativeStackNavigationProp<AppointmentStackParamList, 'EditAppointment'>;
};

export default function EditAppointmentScreen({ navigation }: EditAppointmentScreenProps) {
  return (
