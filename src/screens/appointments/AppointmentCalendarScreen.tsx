...
type AppointmentCalendarScreenProps = {
  navigation: NativeStackNavigationProp<AppointmentStackParamList, 'AppointmentCalendar'>;
};

export default function AppointmentCalendarScreen({ navigation }: AppointmentCalendarScreenProps) {
  return (
