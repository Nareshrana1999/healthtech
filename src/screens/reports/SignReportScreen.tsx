...
type SignReportScreenProps = {
  navigation: NativeStackNavigationProp<ReportStackParamList, 'SignReport'>;
};

export default function SignReportScreen({ navigation }: SignReportScreenProps) {
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Sign Report</Text>
