...
type EncountersScreenProps = {
  navigation: NativeStackNavigationProp<MoreStackParamList, 'Encounters'>;
};

export default function EncountersScreen({ navigation }: EncountersScreenProps) {
  return (
