...
type ProviderDetailScreenProps = {
  navigation: NativeStackNavigationProp<MoreStackParamList, 'ProviderDetail'>;
};

export default function ProviderDetailScreen({ navigation }: ProviderDetailScreenProps) {
  return (
