...
type EncounterDetailScreenProps = {
  navigation: NativeStackNavigationProp<MoreStackParamList, 'EncounterDetail'>;
};

export default function EncounterDetailScreen({ navigation }: EncounterDetailScreenProps) {
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Encounter Detail</Text>
