...
type EditEncounterScreenProps = {
  navigation: NativeStackNavigationProp<MoreStackParamList, 'EditEncounter'>;
};

export default function EditEncounterScreen({ navigation }: EditEncounterScreenProps) {
  return (
