...
type EpicIntegrationScreenProps = {
  navigation: NativeStackNavigationProp<MoreStackParamList, 'EpicIntegration'>;
};

export default function EpicIntegrationScreen({ navigation }: EpicIntegrationScreenProps) {
  return (
